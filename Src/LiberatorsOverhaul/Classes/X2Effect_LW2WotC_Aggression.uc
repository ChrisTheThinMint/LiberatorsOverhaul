...
class X2Effect_LW2WotC_Aggression extends X2Effect_Persistent;
...
function GetToHitModifiers(XComGameState_Effect EffectState, XComGameState_Unit Attacker, XComGameState_Unit Target, XComGameState_Ability AbilityState, class<X2AbilityToHitCalc> ToHitType, bool bMelee, bool bFlanking, bool bIndirectFire, out array<ShotModifierInfo> ShotModifiers)
{
    ...
    if(SourceWeapon != none)	
	{
		...
		if (Attacker.HasSquadsight() && class'X2Ability_LiberatorsOperativePerks'.default.AGG_SQUADSIGHT_ENEMIES_APPLY)
		{
		...
		if (BadGuys > 0)
		{
			...
			ShotInfo.Value = Clamp (BadGuys * class'X2Ability_LiberatorsOperativePerks'.default.AGGRESSION_CRIT_BONUS_PER_ENEMY, 0, class'X2Ability_LiberatorsOperativePerks'.default.AGGRESSION_MAX_CRIT_BONUS);
